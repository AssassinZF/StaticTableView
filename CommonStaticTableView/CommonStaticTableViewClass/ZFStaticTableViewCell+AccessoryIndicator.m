//
//  ZFStaticTableViewCell+AccessoryIndicator.m
...
@implementation ZFStaticTableViewCell (AccessoryIndicator)
- (void)configureAccessoryDisclosureIndicatorCellWithViewModel:(ZFStaticTableViewCellViewModel *)viewModel{
    //左侧控件的配置
