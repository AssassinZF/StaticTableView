//
//  ZFStaticTableViewSectionViewModel.m
...
@implementation ZFStaticTableViewSectionViewModel
...
{
    ZFStaticTableViewCellViewModel *viewMoel = _cellViewModelsArray.firstObject;
